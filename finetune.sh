...
accelerate launch accelerate_rlaif/training_grpo_with_reward_model.py dataset.json /models/final_reward_model Qwen/Qwen2-0.5B models/grpo_model_constitution_FINAL
