...
from tests.deepeval_tests import test_deepeval_benchmarks
...
if __name__ == "__main__":
    ...
    # finetune_and_merge_weights(model_name=BASE_MODEL_NAME)
    ...
    final_model_name = grpo_sft_model_with_reward_model(model_name=sft_model_name, constitution_path='constitution_from_doc.json')
